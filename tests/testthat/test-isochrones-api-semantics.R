...
# Measure/geography/year semantics: 1332 and 1339 are NOT interchangeable, and
...
test_that("2023 active and 2025 roster snapshot are not interchangeable", {
  ...
  expect_equal(snapshot_2025 - active_2023, 7L)      # the 7 future-dated ABU certs
...
test_that("wide slice reconciles and carries explicit status columns", {
  ...
  expect_equal(w$combined_active[w$year == 2023L], 1332L)
